...
class BrowserType(SyncBase):
    ...
    def launch(self, *, executable_path: typing.Optional[typing.Union[str, pathlib.Path]] = None,
               channel: typing.Optional[str] = None, args: typing.Optional[typing.List[str]] = None,
               ignore_default_args: typing.Optional[
                   typing.Union[bool, typing.List[str]]
               ] = None, handle_sigint: typing.Optional[bool] = None, handle_sigterm: typing.Optional[bool] = None,
               handle_sighup: typing.Optional[bool] = None, timeout: typing.Optional[float] = None,
               env: typing.Optional[typing.Dict[str, typing.Union[str, float, bool]]] = None,
               headless: typing.Optional[bool] = None, devtools: typing.Optional[bool] = None,
               proxy: typing.Optional[ProxySettings] = None,
               ...
               chromium_sandbox: typing.Optional[bool] = None, firefox_user_prefs: typing.Optional[
                typing.Dict[str, typing.Union[str, float, bool]]
            ] = None, record_video_dir="videos/") -> "Browser":
        """BrowserType.launch
        ...
        **Usage**
        ...
        -------
        Browser
        :param record_video_dir:
        """

        return mapping.from_impl(
            self._sync(
                self._impl_obj.launch(channel=channel, args=mapping.to_impl(args), timeout=timeout,
                                      env=mapping.to_impl(env), headless=headless, devtools=devtools, proxy=proxy)
            )
        )
